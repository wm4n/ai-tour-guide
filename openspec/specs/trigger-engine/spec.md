...
Evaluates the user's GPS position against nearby POIs and automatically triggers narration when the user enters a POI's radius. Also provides a manual bypass path for map marker taps.
