# Capability: Maps API Key Injection

## Purpose

Secures Google Maps API keys by injecting them at build time through platform-specific configuration files rather than hardcoding them.
