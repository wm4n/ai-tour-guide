# Capability: Default Fallback Location

## Purpose

Provides a language-appropriate GPS fallback when real GPS position is unavailable or delayed, ensuring POI discovery and trigger evaluation work seamlessly even without immediate device location access.
