# Capability: POI Selector

## Purpose

Implements intelligent selection of a single POI from a list of candidates using LLM-based evaluation. The selector considers factors like Wikipedia availability, distance, and previous narration context to choose the most narratable POI.
